...
\begin{align*}
\mathbf{B}=\begin{pmatrix}-3\\[4pt]-1\\[4pt]14\end{pmatrix},\qquad
\mathbf{C}=\begin{pmatrix}-11\\[4pt]4\\[4pt]20\end{pmatrix}.
\end{align*}
...
=\begin{pmatrix}-11\\[4pt]4\\[4pt]20\end{pmatrix}
-\begin{pmatrix}-3\\[4pt]-1\\[4pt]14\end{pmatrix}
=\begin{pmatrix}-8\\[4pt]5\\[4pt]6\end{pmatrix}.
\end{align*}
...
Therefore the length $BC$ is $5\sqrt{5}$ (approximately $11.18$).
